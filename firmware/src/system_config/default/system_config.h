...
#define SYS_PORT_C_TRIS         0xDFE1
#define SYS_PORT_C_LAT          0x0000
#define SYS_PORT_C_ODC          0x0008
#define SYS_PORT_C_CNPU         0x0000
#define SYS_PORT_C_CNPD         0x0000
#define SYS_PORT_C_CNEN         0x0000

#define SYS_PORT_D_ANSEL        0x1900
#define SYS_PORT_D_TRIS         0x193E
...
#define SYS_PORT_F_ANSEL        0xCEE8
#define SYS_PORT_F_TRIS         0xCEE8
...
#define SYS_PORT_G_TRIS         0xFCFE
#define SYS_PORT_G_LAT          0x0000
#define SYS_PORT_G_ODC          0x0000
#define SYS_PORT_G_CNPU         0x0000
#define SYS_PORT_G_CNPD         0x0000
#define SYS_PORT_G_CNEN         0x0002

#define SYS_PORT_H_ANSEL        0x6130
#define SYS_PORT_H_TRIS         0x6130
...
#define SYS_PORT_J_ANSEL        0x0F02
...
#define ADC_SEL_EXTERNALToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_0)
#define ADC_SEL_EXTERNALOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_0)
#define ADC_SEL_EXTERNALOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_0)
#define ADC_SEL_EXTERNALStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_0)
#define ADC_SEL_EXTERNALStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_0, Value)

/*** Functions for DPE_PULSE pin ***/
#define DPE_PULSEToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_1)
#define DPE_PULSEOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_1)
#define DPE_PULSEOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_1)
#define DPE_PULSEStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_1)
#define DPE_PULSEStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_1, Value)

/*** Functions for NFORCE_SAFE1 pin ***/
#define NFORCE_SAFE1Toggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_2)
#define NFORCE_SAFE1On() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_2)
#define NFORCE_SAFE1Off() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_2)
#define NFORCE_SAFE1StateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_2)
#define NFORCE_SAFE1StateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_2, Value)

/*** Functions for NFORCE_SAFE0 pin ***/
#define NFORCE_SAFE0Toggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_9)
#define NFORCE_SAFE0On() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_9)
#define NFORCE_SAFE0Off() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_9)
#define NFORCE_SAFE0StateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_9)
#define NFORCE_SAFE0StateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_9, Value)
...
/*** Functions for DPE_EXT_OVERIDE_EN pin ***/
#define DPE_EXT_OVERIDE_ENToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_10)
#define DPE_EXT_OVERIDE_ENOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_10)
#define DPE_EXT_OVERIDE_ENOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_10)
#define DPE_EXT_OVERIDE_ENStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_10)
#define DPE_EXT_OVERIDE_ENStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_10, Value)
...
/*** Functions for CK_ARRAY pin ***/
#define CK_ARRAYToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_F, PORTS_BIT_POS_0)
#define CK_ARRAYOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_F, PORTS_BIT_POS_0)
#define CK_ARRAYOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_F, PORTS_BIT_POS_0)
#define CK_ARRAYStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_F, PORTS_BIT_POS_0)
#define CK_ARRAYStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_F, PORTS_BIT_POS_0, Value)
...
#define NFORCE_SAFE2Toggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_E, PORTS_BIT_POS_2)
#define NFORCE_SAFE2On() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_E, PORTS_BIT_POS_2)
#define NFORCE_SAFE2Off() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_E, PORTS_BIT_POS_2)
#define NFORCE_SAFE2StateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_E, PORTS_BIT_POS_2)
#define NFORCE_SAFE2StateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_E, PORTS_BIT_POS_2, Value)

/*** Functions for ADC_DONE pin ***/
#define ADC_DONEStateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_15)
...
#define ADC_OUT_10_PORT PORT_CHANNEL_G
#define ADC_OUT_10_PIN PORTS_BIT_POS_7
#define ADC_OUT_10_PIN_MASK (0x1 << 7)
...
#define ADC_OUT_9_PIN PORTS_BIT_POS_1
#define ADC_OUT_9_PIN_MASK (0x1 << 1)
...
#define ADC_OUT_11_PORT PORT_CHANNEL_G
#define ADC_OUT_11_PIN PORTS_BIT_POS_12
#define ADC_OUT_11_PIN_MASK (0x1 << 12)

/*** Functions for ADC_OUT_12 pin ***/
#define ADC_OUT_12_PORT PORT_CHANNEL_G
#define ADC_OUT_12_PIN PORTS_BIT_POS_13
#define ADC_OUT_12_PIN_MASK (0x1 << 13)
