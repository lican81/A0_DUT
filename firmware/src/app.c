...
void APP_Tasks ( void )
{
    ...
    switch ( appData.state )
    {
        ...
        case APP_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                appData.sysTmrHandle1 = SYS_TMR_CallbackPeriodic(1000, 0, &APP_Tmr_Sys_Service_Callback_Delay1);
                appData.sysTmrHandle2 = SYS_TMR_CallbackPeriodic(10000, 0, &APP_Tmr_Sys_Service_Callback_Delay2);
        ...
        case APP_STATE_SERVICE_TASKS:
        {
            ...
            {
//                PLIB_PORTS_Toggle( PORTS_ID_0, PORT_CHANNEL_H, 0x1);
                appData.delay1Expired = false;
                SYS_PRINT(".");
            }
